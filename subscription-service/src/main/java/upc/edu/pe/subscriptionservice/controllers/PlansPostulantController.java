...
public class PlansPostulantController {
	...
	@GetMapping(path = "/id/{id}/postulants", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Operation(summary = "Create Plan to Postulant", description = "Create new plan of subscription for postulants: Description limit: 70 characters, Status limit: 1 character", tags = {"plans_postulant"})
	@ApiResponses( value = {
	...
	@DeleteMapping(path = "/id/{id}/postulants", produces = MediaType.APPLICATION_JSON_VALUE)
